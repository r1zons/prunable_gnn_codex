...
SUITE_AGGREGATE_COLUMNS = [
    ...
    "num_runs",
    "aggregation_status",
    "achieved_sparsity_mean",
    "achieved_sparsity_std",
    "achieved_sparsity_ci95",
    "final_reward_mean",
    "final_reward_std",
    "final_reward_ci95",
    "num_adaptive_steps_mean",
    "num_adaptive_steps_std",
    "num_adaptive_steps_ci95",
    "val_accuracy_mean",
    "val_accuracy_std",
    "val_accuracy_ci95",
    "val_macro_f1_mean",
    ...
    "inference_time_mean_ms_ci95",
    "parameter_count_mean",
    "parameter_count_std",
    "parameter_count_ci95",
]
